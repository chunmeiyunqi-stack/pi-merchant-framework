...
| V2.0.0 | 2026-05-15 | 新增商业化核心能力：License 授权验证系统（HMAC-SHA256 + Feature Gate）、多租户架构（CRUD + 配额控制 + 状态隔离）、用量统计与 Webhook Flush；代码质量加固（TypeScript 严格模式，190/190 测试全通过） | 技术团队 |
