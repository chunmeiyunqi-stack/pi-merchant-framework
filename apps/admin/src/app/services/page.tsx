              ...
              services.map((s) => (
                <tr key={s.id} className="border-b last:border-0 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    ...
                    >
                      {s.status === 'ACTIVE' ? '上架中' : '已下架'}
                    </span>
                  </td>
                  <td className="px-4 py-3">
                    <button className="text-[#7C3AED] hover:text-[#6D28D9] text-sm font-medium mr-3">
                      编辑
                    </button>
