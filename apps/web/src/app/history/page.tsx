  ...
  return (
    <main className="min-h-screen bg-[#0A0510] text-gray-100 font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[40%] bg-[#7C3AED]/15 blur-[150px] rounded-full" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#F3C136]/8 blur-[150px] rounded-full" />
      </div>
      ...
      <header className="sticky top-0 z-50 bg-[#0A0510]/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 sm:px-6 h-16">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-base font-bold text-white leading-none">生成历史</h1>
              <p className="text-[10px] text-gray-500 mt-0.5">Generation History</p>
            </div>
          </div>
