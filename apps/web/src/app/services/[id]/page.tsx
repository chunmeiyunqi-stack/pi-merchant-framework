...
export default function ServiceDetailPage({ params }: { params: { id: string } }) {
  ...
  const service = {
    ...
    title: '高级光疗美甲',
    description:
      '采用顶级环保光疗胶，色彩饱和度高，持久不脱落（平均可维持30-40天）。包含完整的日式手部死皮特护及抛光处理，由具有5年资历以上的资深美甲师全程为您操作。过程温馨无痛。',
    price: 12.0,
  };
    ...
    <main className="max-w-md mx-auto min-h-screen bg-gray-50 flex flex-col border-x border-gray-100">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="bg-white p-6 mb-2">
          <div className="inline-block px-3 py-1 bg-purple-100 text-[#7C3AED] text-xs font-bold rounded-lg mb-4 cursor-default">
            热门推荐
          </div>
