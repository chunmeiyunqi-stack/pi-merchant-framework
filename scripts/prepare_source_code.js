...
const FILES_TO_PROCESS = [
  // Ensure latest important libs and routes are included first
  ['apps/web/src/lib/session.ts', '会话令牌生成与验证'],
  ['apps/web/src/lib/rate-limit.ts', '速率限制实现（开发内存/生产建议 Redis）'],
  ['apps/web/src/app/api/v1/models/route.ts', '模型列表 API 路由（models）'],
  ['apps/web/src/app/api/v1/history/route.ts', '生成历史查询 API 路由（history）'],
...
const OUTPUT_FILE = 'source_code_v2.0.0_copyright_final.md';
